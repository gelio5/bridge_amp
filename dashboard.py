        ...
        figure={
            'data': [
                ...
                {'x': df[df['experiment'] == 'exp_1']['cycles'],
                 ...
                 'name': 'exp_1_bottom'},
                {'x': df[df['experiment'] == 'exp_2']['cycles'],
                 'y': df[df['experiment'] == 'exp_2']['top_mean_values_approximated'], 'type': 'line',
                 'name': 'exp_2_top'},
                {'x': df[df['experiment'] == 'exp_2']['cycles'],
                 'y': df[df['experiment'] == 'exp_2']['bottom_mean_values_approximated'], 'type': 'line',
                 'name': 'exp_2_bottom'},
                {'x': df[df['experiment'] == 'exp_3']['cycles'],
                ...
                {'x': df[df['experiment'] == 'exp_4']['cycles'],
                 ...
                 'name': 'exp_4_bottom'},
                {'x': df[df['experiment'] == 'exp_5']['cycles'],
                 'y': df[df['experiment'] == 'exp_5']['top_mean_values_approximated'], 'type': 'line',
                 'name': 'exp_5_top'},
                {'x': df[df['experiment'] == 'exp_5']['cycles'],
                 'y': df[df['experiment'] == 'exp_5']['bottom_mean_values_approximated'], 'type': 'line',
                 'name': 'exp_5_bottom'},
                {'x': df[df['experiment'] == 'exp_6']['cycles'],
                 'y': df[df['experiment'] == 'exp_6']['top_mean_values_approximated'], 'type': 'line',
                 'name': 'exp_6_top'},
                {'x': df[df['experiment'] == 'exp_6']['cycles'],
                 'y': df[df['experiment'] == 'exp_6']['bottom_mean_values_approximated'], 'type': 'line',
                 'name': 'exp_6_bottom'},
                {'x': df[df['experiment'] == 'exp_7']['cycles'],
                ...
                {'x': df[df['experiment'] == 'exp_7']['cycles'],
                 ...
                 'name': 'exp_7_bottom'},
                {'x': df[df['experiment'] == 'exp_8']['cycles'],
                 'y': df[df['experiment'] == 'exp_8']['top_mean_values_approximated'], 'type': 'line',
                 'name': 'exp_8_top'},
                {'x': df[df['experiment'] == 'exp_8']['cycles'],
                 'y': df[df['experiment'] == 'exp_8']['bottom_mean_values_approximated'], 'type': 'line',
                 'name': 'exp_8_bottom'},
            ],
            'layout': {
    ...
    dcc.Graph(
        ...
        figure={
            'data': [
                ...
                {'x': df[df['experiment'] == 'exp_2']['cycles'],
                 'y': df[df['experiment'] == 'exp_2']['top_approximated_gradient'], 'type': 'line',
                 'name': 'exp_2_top'},
                {'x': df[df['experiment'] == 'exp_2']['cycles'],
                 'y': df[df['experiment'] == 'exp_2']['bottom_approximated_gradient'], 'type': 'line',
                 'name': 'exp_2_bottom'},
                ...
                {'x': df[df['experiment'] == 'exp_5']['cycles'],
                 'y': df[df['experiment'] == 'exp_5']['top_approximated_gradient'], 'type': 'line',
                 'name': 'exp_5_top'},
                {'x': df[df['experiment'] == 'exp_5']['cycles'],
                 'y': df[df['experiment'] == 'exp_5']['bottom_approximated_gradient'], 'type': 'line',
                 'name': 'exp_5_bottom'},

                {'x': df[df['experiment'] == 'exp_6']['cycles'],
                 'y': df[df['experiment'] == 'exp_6']['top_approximated_gradient'], 'type': 'line',
                 'name': 'exp_6_top'},
                {'x': df[df['experiment'] == 'exp_6']['cycles'],
                 'y': df[df['experiment'] == 'exp_6']['bottom_approximated_gradient'], 'type': 'line',
                 'name': 'exp_6_bottom'},
                ...
                {'x': df[df['experiment'] == 'exp_8']['cycles'],
                 'y': df[df['experiment'] == 'exp_8']['top_approximated_gradient'], 'type': 'line',
                 'name': 'exp_8_top'},
                {'x': df[df['experiment'] == 'exp_8']['cycles'],
                 'y': df[df['experiment'] == 'exp_8']['bottom_approximated_gradient'], 'type': 'line',
                 'name': 'exp_8_bottom'},
            ],
            'layout': {
